...
import org.example.listeners.RestAssuredListener;
...
public class AllureReportGeneration extends BaseTest {
	...
	public void e2eAPIRequest() {
		...
		try {
			String postAPIRequestBody = FileUtils.readFileToString(new File(FileNameConstants.POST_REQUEST_JSON),
					"UTF-8");
			String tokenAPIRequestBody = FileUtils.readFileToString(new File(FileNameConstants.TOKEN_REQUEST_JSON),
					"UTF-8");
			String putAPIRequestBody = FileUtils.readFileToString(new File(FileNameConstants.PUT_REQUEST_JSON),
					"UTF-8");
			String patchAPIRequestBody = FileUtils.readFileToString(new File(FileNameConstants.PATCH_REQUEST_JSON),
					"UTF-8");
